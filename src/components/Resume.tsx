      ...
      <div className="container max-w-5xl mx-auto px-4">
        ...
        <div className="flex flex-col items-center justify-center">
          <div className="bg-secondary/30 p-8 rounded-lg max-w-lg w-full text-center">
            ...
            <a href="https://drive.google.com/uc?export=download&id=1msBGpwF_MdDkjU3Vzf25z3tfZKO-9pDt" className="inline-flex items-center px-6 py-3 bg-primary text-primary-foreground rounded-md hover:bg-primary/90 transition-colors">
